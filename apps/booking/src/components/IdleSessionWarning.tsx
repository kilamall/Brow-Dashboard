// apps/booking/src/components/IdleSessionWarning.tsx
// Warning banner shown before automatic sign out due to idle session
...
interface IdleSessionWarningProps {
  ...
  /** Warning time in minutes before sign out (default: 5) */
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 bg-amber-500 text-white px-4 py-3 shadow-lg">
      <div className="max-w-6xl mx-auto flex items-center justify-between gap-4">
        ...
        <button
          onClick={resetTimer}
          className="px-4 py-2 bg-white text-amber-600 rounded-lg hover:bg-amber-50 font-medium transition-colors whitespace-nowrap"
        >
          Stay Signed In
        </button>
      </div>
